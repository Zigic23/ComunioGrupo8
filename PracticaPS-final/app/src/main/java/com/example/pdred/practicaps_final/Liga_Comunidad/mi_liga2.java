...
public class mi_liga2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ArrayList<Usuario> listado = new ArrayList<>();
        listado.add(getCurrentUser());
        setContentView(R.layout.activity_mi_liga2);
        setAll(listado);
    }
    ...
    public void setAll (ArrayList<Usuario> listac) {
        ...
        lista.setAdapter(new Lista_adaptador_Liga(this, R.layout.entrada_liga, listac) {
            ...
            public void onEntrada(Object entrada, View view) {
                ...
                texto_puntos.setText(String.valueOf(((Usuario) entrada).getPuntos()));
